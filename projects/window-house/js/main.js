...
/* harmony import */ var _functions_header_height__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./functions/header-height */ "./src/js/functions/header-height.js");
...
/* harmony import */ var _functions_spollers__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./functions/spollers */ "./src/js/functions/spollers.js");
/* harmony import */ var _functions_dynamic_adapt__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./functions/dynamic-adapt */ "./src/js/functions/dynamic-adapt.js");
/* harmony import */ var _functions_dynamic_adapt__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_functions_dynamic_adapt__WEBPACK_IMPORTED_MODULE_7__);
// ========================================================================================
...
var tabs = new graph_tabs__WEBPACK_IMPORTED_MODULE_2__["default"]('products-tabs');
var tabs2 = new graph_tabs__WEBPACK_IMPORTED_MODULE_2__["default"]('about-company-tabs'); // ========================================================================================
// Получение высоты шапки сайта (не забудьте вызвать функцию)


(0,_functions_header_height__WEBPACK_IMPORTED_MODULE_3__.getHeaderHeight)(); // ========================================================================================
...
swiper__WEBPACK_IMPORTED_MODULE_5__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_5__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_5__.Pagination, swiper__WEBPACK_IMPORTED_MODULE_5__.EffectFade]);
document.querySelectorAll('.products-slider').forEach(function (el) {
  var products = new swiper__WEBPACK_IMPORTED_MODULE_5__["default"](el, {
    slidesPerView: 1,
    spaceBetween: 100,
    speed: 750,
    observer: true,
...
var reviews = new swiper__WEBPACK_IMPORTED_MODULE_5__["default"]('.reviews-slider', {
  slidesPerView: 1,
  spaceBetween: 100,
  speed: 750,
  observer: true,
...
var portfolio = new swiper__WEBPACK_IMPORTED_MODULE_5__["default"]('.portfolio-slider', {
  slidesPerView: 4,
  spaceBetween: 45,
  speed: 750,
  observer: true,
...
document.querySelectorAll('.portfolio-modal-slider').forEach(function (el) {
  var portfolioModal = new swiper__WEBPACK_IMPORTED_MODULE_5__["default"](el, {
    slidesPerView: 1,
    spaceBetween: 50,
    speed: 750,
    observer: true,
...
_functions_spollers__WEBPACK_IMPORTED_MODULE_6__.spollers(); // ========================================================================================
// Подключение галереи
...
if (document.querySelector('.portfolio-modal-map')) {
  document.querySelectorAll('.portfolio-modal-map').forEach(function (el) {
    function init() {
...
(function () {
  ...
  burger === null || burger === void 0 ? void 0 : burger.addEventListener('click', function (e) {
    ...
    overlay === null || overlay === void 0 ? void 0 : overlay.classList.toggle('overlay--visible');
  ...
  overlay === null || overlay === void 0 ? void 0 : overlay.addEventListener('click', function () {
    ...
    overlay === null || overlay === void 0 ? void 0 : overlay.classList.remove('overlay--visible');
    (0,_functions_enable_scroll__WEBPACK_IMPORTED_MODULE_1__.enableScroll)();
  });
  ...
  if (spollersArray.length > 0) {
    ...
    if (spollersMedia.length > 0) {
      ...
      mediaQueries.forEach(function (breakpoint) {
        ...
        var matchMedia = window.matchMedia(paramsArray[0]); // Объекты с нужным условием 
