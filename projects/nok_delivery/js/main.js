...
/* harmony import */ var _components_download_app__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/download-app */ "./src/js/components/download-app.js");
...
var modal = new graph_modal__WEBPACK_IMPORTED_MODULE_2__["default"](); // ========================================================================================
// Реализация табов
...
var swiper = new swiper__WEBPACK_IMPORTED_MODULE_4__["default"]('.product-categories__swiper', {
  slidesPerView: 4,
  spaceBetween: 21,
  breakpoints: {
    320: {
...
/***/ "./src/js/components/download-app.js":
/*!*******************************************!*\
  !*** ./src/js/components/download-app.js ***!
  \*******************************************/
/***/ (() => {
...
if (document.querySelector('.download-app-block__list')) {
  var downloadAppBlockList = document.querySelectorAll('.download-app-block__list');
  downloadAppBlockList.forEach(function (el) {
    var downloadAppBlockNumbers = el.querySelectorAll('.download-app-block__number');

    for (var number = 0; number < downloadAppBlockNumbers.length; number++) {
...
/***/ "./src/js/components/questionnaire-form.js":
/*!*************************************************!*\
  !*** ./src/js/components/questionnaire-form.js ***!
  \*************************************************/
/***/ (() => {
...
if (document.querySelector('.questionnaire-form-file')) {
  var questionnaireFormFile = document.querySelector('.questionnaire-form-file');
  var input = questionnaireFormFile.querySelector('.questionnaire-form-file__input');
  var content = questionnaireFormFile.querySelector('.questionnaire-form-file__content');
